        ...
        <div class="partner_vlide">
            <div class="ohbox">
                <ul class="piclist">
                    ...
                    <li><a href="{{$base->url.'authDetail?id='.$auth->id}}" target="_blank"><img src="{{$base->url.'uploads/'.$auth->cover}}" alt="{{$auth->title}}" /><span>{{$auth->title}}</span></a></li>
        ...
        <div class="warp_item">
            <div class="item_coc">
                <ul>
                    ...
                    @foreach($auths as $auth)
                    <li>
                        <div class="item_coc_li"><a href="{{$base->url.'authDetail?id='.$auth->id}}"target="_blank">
                                <div class="item_coc_li_A"><img src="{{$base->url.'uploads/'.$auth->cover}}" alt="{{$auth->title}}" /></div>
